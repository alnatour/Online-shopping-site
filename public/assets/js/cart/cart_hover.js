        ...
        xhttp.onreadystatechange = function () {
            if (this.status == 200 && this.readyState == 4) {
                ...
                for (var product in products) {
                    ...
                    div.innerHTML = "<table class='cart-table'><tbody><tr style='border-bottom:1px solid #000'><td class='si-pic'><a href=\"view/main/single.php?id=" + products[product]['id'] + "\"><img src='public/uploads/productImages/" 
...
//For Single page
$(document).ready(function () {
    $(".cartToHoverSingle").on("mouseenter", function () {
        var xhttp = new XMLHttpRequest();
        ...
        xhttp.onreadystatechange = function () {
            if (this.status == 200 && this.readyState == 4) {
                ...
                var container = document.getElementById('cartDivHover1');
                container.innerHTML = "";
