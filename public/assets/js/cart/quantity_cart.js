...
function removeOneQuantityFromCart(productId, productPrice) {
    ...
    xhttp.open("GET", "../../../controlle/cart/remove_from_cart_controller.php?pid=" + productId + "&pqty=1", true);
    xhttp.send();
}