            ...
            <div class="container">
                ...
                <div class="ht-right">
                    <?php if (!isset($_SESSION['user'] )) { ?>
                        <a class="login-panel pr-4" href="<?php echo BASE_URL . 'registration/register.php' ?>" ><i class="fa fa-registered"></i>Register</a> 
                        <a class="login-panel pr-4" href="<?php echo BASE_URL . 'registration/login.php' ?>" ><i class="fa fa-user"></i>Login </a> 
                    <?php  } ?>

                    <?php if( isset($_SESSION['user']) ) { ?>
                        <a class="login-panel pr-4">Welcom <?php echo $_SESSION['user']->getLastname()?></a> </li>
                        <a class="login-panel pr-4" href="<?php echo BASE_URL . 'article/posts.php'?>" > Admin Plan</a>
                        <a class="login-panel pr-4" href="<?php echo BASE_URL . 'registration/log_out.php' ?>" >Log out</a>
                    <?php } ?>
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover" >
                                    <div class="select-items" id="cartToHover">
                                    ...
                                    <div class="select-button">
                                        <a href="cart/cart.php" class="primary-btn view-card">VIEW CARD</a>
                                        <a href="#" class="primary-btn checkout-btn">CHECK OUT</a>
                                    </div>
                                </div>
                            </li>
                            <li class="cart-price"  id="cartTotalPrice">$<?= $cartTotalPrice ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                    ...
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <?php foreach ($categories as $category) { 
                                ...
                                <li  <?php if(isset($_GET['cid'])){echo $active;}?>">
                                    <a href="<?php echo BASE_URL . 'index.php?cid='?><?= $category->getId() ?>"><?= $category->getName() ?></a>
                                </li>
                            <?php }?>
                        </ul>
                    </div>
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="<?php echo BASE_URL . 'contact_with_us/contact.php' ?>">Contact</a></li>
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="<?php echo BASE_URL . 'registration/login.php' ?>">Login</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Address: 60-49 Road 11378 Austria</li>
                            <li>Phone: +43 681108685666</li>
                            <li>Email: aaa.alnatour@gmail.com</li>
                        </ul>
...
Copyright Company ALnatour &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i>
                        </div>
